...
const tabsListVariants = cva(
    "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-9 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none data-[variant=pill]:rounded-full",
    {
        variants: {
            variant: {
                default: "bg-muted",
                line: "gap-1 bg-transparent",
                // Segmented-control look: a rounded-full track with one solid
                // accent-filled pill marking the active tab, plain text for
                // the rest — see TabsTrigger for the active-pill styling.
                pill: "gap-1 bg-muted",
            },
        },
        defaultVariants: {
