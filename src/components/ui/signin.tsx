...
import { SignInDialog } from "@/components/ui/signin-dialog.tsx";
...
/**
 * A button component that handles authentication sign in/out with proper loading
 * states and accessibility features.
 *
 * Signing in opens <SignInDialog> (email/password or Google) rather than
 * redirecting straight to an identity provider, since Supabase Auth offers both.
 */
