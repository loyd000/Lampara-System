...
export const AGENT_TOOLS: Record<string, AgentTool> = {
    ...
    [approveQuoteTool.declaration.name]: approveQuoteTool,
    [markContractSignedTool.declaration.name]: markContractSignedTool,
    ...
    [rescheduleInstallationTool.declaration.name]: rescheduleInstallationTool,
    [createTicketTool.declaration.name]: createTicketTool,
